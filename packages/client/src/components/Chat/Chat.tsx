                  ...
                  <Card.Content className="p-4 space-y-4">
                    <Fieldset className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Select the AI model to use</p>
                      </div>
                  ...
                  <Card.Content className="p-4 space-y-4">
                    ...
                    <Fieldset className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Number of tokens per chunk</p>
                      </div>
                      <Input
                        id="chunks"
                        type="number"
                  ...
                  <Card.Content className="p-4 space-y-4">
                    ...
                    <Fieldset className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Display source information</p>
                      </div>
